(() => {
  ...
  const GENERATOR_VERSION='12.11',MAX_TRANSFER_BYTES=4_000_000;
  ...
  function renderControls(){
    ...
    content.innerHTML=`<div class="jd-graphic-shell"><div class="jd-graphic-intro"><div><span class="eyebrow">SOCIAL GRAPHICS</span><h2>Player of the Week Generator</h2><p>Choose one of three Jersey Dodgers poster styles, then customize the player, 3–5 stats and text while the live preview stays visible.</p></div><span class="jd-graphic-size">1080 × 1350 · 4:5 · V12.11</span></div><div class="jd-graphic-layout">
